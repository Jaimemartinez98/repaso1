...
@section('content')
    ...
    <form action="{{ route('encuestas.update', $encuesta->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="pregunta_1" name="pregunta_1"
                    placeholder="Ingrese la pregunta numero 1" value="{{ $encuesta->pregunta_1 }}">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="pregunta_2" name="pregunta_2"
                    placeholder="Ingrese la pregunta numero 2" value="{{ $encuesta->pregunta_2 }}">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="pregunta_3" name="pregunta_3"
                    placeholder="Ingrese la pregunta numero 3" value="{{ $encuesta->pregunta_3 }}">
