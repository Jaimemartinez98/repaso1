    ...
    <form action="{{ route('encuestas.update', $encuesta->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <input type="email" class="form-control" id="pregunta_1" name="pregunta_1"
            ...
            <div class="col-6">
                ...
                <input type="email" class="form-control" id="pregunta_2" name="pregunta_2"
            ...
            <div class="col-6">
                ...
                <input type="email" class="form-control" id="pregunta_3" name="pregunta_3"
